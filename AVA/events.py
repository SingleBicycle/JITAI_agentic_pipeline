...
from .text_similarity import get_bert_scorer
...
def batch_generate_descriptions(
    ...
    while remaining_indices:
        ...
        description_prompt_name = global_config.get("description_prompt_name", "generate_description")
        description_prompt = PROMPTS.get(description_prompt_name, PROMPTS["generate_description"])
...
def semantic_chunking(
    ...
    scorer = get_bert_scorer(model_type="microsoft/deberta-xlarge-mnli", lang="en")
